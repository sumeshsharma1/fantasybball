...
def call_hidden_data(last_n_days_team_analysis, league_id):
    if last_n_days_team_analysis == "season":
        hidden_df_team = league_analysis(year=2023, leagueid=int(league_id))
    else:
        hidden_df_team = league_analysis(year=2023, leagueid=int(league_id), last_n_days=int(last_n_days_team_analysis))
