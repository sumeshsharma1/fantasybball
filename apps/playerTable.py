...
total_df_with_salaries = create_base_df(season_year=2023)
...
total_df_with_salaries['2023-24'] = total_df_with_salaries['2023-24'].replace('[\$,]', '', regex=True).astype(float)
...
temp_table_col_ordering_first = ['name', 'team', 'positions', '2023-24', 'avg_fantasy_pts']
